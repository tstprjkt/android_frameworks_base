...
public final class CachedAppOptimizer {
    ...
    void freezeAppAsyncLSP(ProcessRecord app) {
        ...
        synchronized (mProcLock) {
            if (isSystemProcess(app.info.packageName) || isProcessInteractive(app) || isFrozenProcessInteractive(app.info.packageName)) {
    ...
    public boolean isSystemProcess(String packageName) {
        return packageName.toLowerCase().contains("com.android") 
                || packageName.toLowerCase().contains("com.google.android")
    ...
    void onOomAdjustChanged(int oldAdj, int newAdj, ProcessRecord app) {
        ...
        if (isProcessInteractive(app) || isSystemProcess(app.info.packageName)) {
            return;
        }
